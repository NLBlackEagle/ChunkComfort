...
public class FireBlockRegistry {
    ...
    public static void register(Block block) { FIRE_BLOCKS.add(block); }
    public static boolean contains(Block block) { return FIRE_BLOCKS.contains(block); }
    public static void clear() { FIRE_BLOCKS.clear(); }
